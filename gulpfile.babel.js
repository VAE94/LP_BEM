...
gulp.task('browserSync', () => {
  ...
  gulp.watch(['app/videos/**/*'], gulp.series('videos', reload));
...
gulp.task('default', gulp.series(
  ...
  // generate styles
  'styles',
  // parse html, scripts, images, videos
  'html', 'scripts:bundle', 'scripts', 'images', 'videos', 'fonts',
  // move to dist
  'copy'
  )
);
...
gulp.task('build:prod', gulp.series(
  ...
  'styles:minify',
  // parse html, scripts, images, videos
  'html', 'scripts:bundle', 'scripts:minify', 'images:minify', 'videos:minify', 'fonts',
  // move to dist
  'copy'
));
